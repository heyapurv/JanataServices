        ...
        <section className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    <div className="pb-6">
                        <h3 className="text-4xl font-bold text-purple-700 underline underline-offset-8">
                        Janata Services
                        </h3>
                    </div>
                    <figure>
                        ...
                        <div className="mt-10">
                            <img src="" className="w-16 h-16 mx-auto rounded-full" />
                            <div className="mt-3">
                                <span className="block text-gray-800 font-semibold">XYX Dfdfd</span>
                                <span className="block text-gray-600 text-sm mt-0.5">Founder Janata Services</span>
                            </div>
                        </div>
                    </figure>
                </div>

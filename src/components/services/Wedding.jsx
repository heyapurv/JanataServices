...
<div className="bg-white">
      ...
      <img
       ...
       <div className="mt-16 grid grid-cols-3 gap-8">
         ...
         <h3 className="mt-4 text-lg font-semibold text-blue-500">MakeUp Artists</h3>
         </a>
        <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
        <i className="fas fa-home fa-2x text-blue-500"></i>
        <h3 className="mt-4 text-lg font-semibold text-blue-500">Venue Rental</h3>
        </a>
        <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
        <i className="fas fa-lightbulb fa-2x text-blue-500"></i>
        <h3 className="mt-4 text-lg font-semibold text-blue-500">Catering Services</h3>
        </a>
        <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
        <i className="fas fa-utensils fa-2x text-blue-500"></i>
        <h3 className="mt-4 text-lg font-semibold text-blue-500">Photography</h3>
        </a>
        <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
        <i className="fas fa-utensils fa-2x text-blue-500"></i>
        <h3 className="mt-4 text-lg font-semibold text-blue-500">Entertainment</h3>
        </a>
        <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
       <i className="fas fa-user-tie fa-2x text-blue-500"></i>
       <h3 className="mt-4 text-lg font-semibold text-blue-500">Wedding Garments</h3>
       </a> 
       <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
       <i className="fas fa-user-tie fa-2x text-blue-500"></i>
       <h3 className="mt-4 text-lg font-semibold text-blue-500">Party Organisers</h3>
       </a> 
       <a href="#" className="bg-gray-100 rounded-lg p-4 text-center">
       <i className="fas fa-user-tie fa-2x text-blue-500"></i>
       <h3 className="mt-4 text-lg font-semibold text-blue-500">Choreographers</h3>
       </a>
      </div>
